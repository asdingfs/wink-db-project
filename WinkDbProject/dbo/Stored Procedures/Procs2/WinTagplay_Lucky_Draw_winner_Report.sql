...
Create PROCEDURE [dbo].[WinTagplay_Lucky_Draw_winner_Report]
(
...
--
		...
		IF(@incampaign_id is null or @incampaign_id ='' or @incampaign_id =0)
		set @incampaign_id = NULL
