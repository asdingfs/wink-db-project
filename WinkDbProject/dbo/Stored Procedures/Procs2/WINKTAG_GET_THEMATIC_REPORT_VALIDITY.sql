CREATE PROC [dbo].[WINKTAG_GET_THEMATIC_REPORT_VALIDITY]
(
...
BEGIN
	...
	IF (@CAMPAIGN_ID = 146)
	BEGIN
	EXEC [dbo].[WINKTAG_GET_THEMATIC_REPORT_VALIDITY_WFH2020] 
	@customer_name ,
	@email,
	@gender,
	@customer_id,
			...
			SELECT * FROM 
				(--1 START
					...
					(
						-----table1
						SELECT * from
						(SELECT customer_id,created_at, '' as Q1, '' as Redirection
