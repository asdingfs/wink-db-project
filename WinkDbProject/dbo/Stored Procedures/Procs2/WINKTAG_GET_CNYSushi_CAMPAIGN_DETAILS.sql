...
CREATE PROC [dbo].[WINKTAG_GET_CNYSushi_CAMPAIGN_DETAILS]
@campaign_id int
AS
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			SELECT C.campaign_id,Q.question_id,A.option_id, A.option_type as inventory_count, A.image_name as winner_count
