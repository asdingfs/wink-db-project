...
CREATE PROC [dbo].[WINKTAG_CUSTOMER_EARNED_POINTS_DETAIL_testing_12092023]
@customer_id int,
@campaign_id int,
@question_id int,
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
                ...
                END
                ELSE IF @campaign_type = 'WinkHuntSurveyP1Report'
                BEGIN
                    SET @MESSAGE = 'Yay! You have completed the Survey!';
                END
