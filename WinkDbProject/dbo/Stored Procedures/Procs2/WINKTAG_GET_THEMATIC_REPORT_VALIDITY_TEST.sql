CREATE PROC [dbo].[WINKTAG_GET_THEMATIC_REPORT_VALIDITY_TEST]
(
...
BEGIN
	...
	IF(@CAMPAIGN_ID = 95 or @CAMPAIGN_ID = 93 or @CAMPAIGN_ID = 92 or @CAMPAIGN_ID = 77)
		BEGIN
			SELECT * FROM 
				(--1 START
					...
					(
						-----table1
						SELECT * from
						(SELECT customer_id,created_at, '' as Q1
