CREATE PROC [dbo].[ANALYTICS_INSERT_CUSTOMER_ACTION_LOG_NO_REGISTER_ALL]
AS

BEGIN

INSERT INTO customer_action_log_summary_no_register(customer_id,customer_action_date)
...
,count(*) as count from customer_action_log where customer_id is not null and customer_id != '' and customer_action != 'register' group by customer_id, cast(created_at as date)) as temp 
