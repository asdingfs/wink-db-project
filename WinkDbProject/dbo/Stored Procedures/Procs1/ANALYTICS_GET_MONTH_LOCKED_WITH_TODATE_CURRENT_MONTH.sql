CREATE PROC [dbo].[ANALYTICS_GET_MONTH_LOCKED_WITH_TODATE_CURRENT_MONTH]
...
(
	...
	(
		...
		where customer.group_id in (13,14) and cast(created_at as date)<=cast(@end_date_of_current_month as date)
	) locked left join
