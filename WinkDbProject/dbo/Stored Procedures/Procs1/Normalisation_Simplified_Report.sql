CREATE PROC [dbo].[Normalisation_Simplified_Report]
(
	@wid varchar(50),
	@customerId int,
...
BEGIN
	...
	dup.createdOn, dup.affectedDate, dup.customerId, cus.WID, cus.email,
	cus.first_name +' '+cus.last_name AS customerName
