CREATE Procedure [dbo].[GET_NETs_Motoring_NonStop_Report_backup_org]
(
  @from_date datetime,
  @to_date datetime,
...
print ('AA')
	...
	---- Point Expired is NULL 
			...
			(C.first_name+' '+ C.last_name) as customer_name , A.created_at,A.points_credit_status,A.point_redemption_date
