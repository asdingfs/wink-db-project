...
CREATE PROC [dbo].[Get_Scan_Points_Zin_Win_bak_20042016]          
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					values(@teamId,('Milestone '+(SELECT COUNT(*) FROM game_player_milestone_complete WHERE TEAM_ID = @teamId AND EVENT_ID = @event_id)),GETDATE(),@event_id)
				END
			END	
		END
