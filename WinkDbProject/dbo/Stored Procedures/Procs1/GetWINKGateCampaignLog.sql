-- =============================================
CREATE PROCEDURE [dbo].[GetWINKGateCampaignLog]
(@action_id int)
AS
BEGIN
	...
	BEGIN
		SELECT * 
		from action_log as a, gate_campaign_old_data_log as o, gate_campaign_new_data_log as n
	...
	BEGIN
		SELECT * 
		FROM action_log as a, gate_campaign_old_data_log as n
