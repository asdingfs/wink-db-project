CREATE PROC [dbo].[Get_Scan_Points_With_User_Auth]          
...
-- Check Customer Authentication Token
 ...
 ELSE 
	...
	End
	ELSE
	BEGIN -- END Check Customer Authentication Token
	SELECT '2' as response_code, 'Invalid Scan' as response_message
	RETURN 
	END
