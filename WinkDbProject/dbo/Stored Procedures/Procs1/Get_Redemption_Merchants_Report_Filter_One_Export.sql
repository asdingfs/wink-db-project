...
CREATE PROCEDURE [dbo].[Get_Redemption_Merchants_Report_Filter_One_Export]
(
...
set @gst7Percent=0.07;
	...
	BEGIN
		...
		CASE  
		WHEN(merchant.wink_fee_percent is not null AND merchant.wink_fee_percent != 0 AND  YEAR(eVoucher_transaction.created_at) >='2023')
