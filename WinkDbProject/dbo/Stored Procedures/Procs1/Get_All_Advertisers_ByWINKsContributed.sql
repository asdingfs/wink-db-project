...
CREATE  PROCEDURE [dbo].[Get_All_Advertisers_ByWINKsContributed]
AS
BEGIN
-- Check null or empty
...
(
	...
	SELECT (#tmpmerchant.first_name + ' '+  #tmpmerchant.last_name)  AS advertiser_name,#tmpmerchant.mas_code,SUM(ISNULL(#tmpmerchant.total_winks,0)) AS total_winks
