-- =============================================
CREATE PROCEDURE [dbo].[GetWINKGateAssetLog]
(@action_id int)
AS
BEGIN
	...
	BEGIN
		SELECT * 
		from action_log as a, gate_asset_old_data_log as o,gate_asset_new_data_log as n
	...
	BEGIN
		SELECT * 
		FROM action_log as a, gate_asset_old_data_log as n
