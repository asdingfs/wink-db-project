CREATE Procedure [dbo].[GET_WINKFees_WINKs_Redemption_Report]
(
  @from_date datetime,
  @to_date datetime,
...
BEGIN
		...
		SELECT E.customer_id,A.created_at, A.total_redeemed_winks,
...
alter table WINK_Redemption_Detail_With_WINK_Fees add wink_fees_amount decimal(10,2) not null default 0*/