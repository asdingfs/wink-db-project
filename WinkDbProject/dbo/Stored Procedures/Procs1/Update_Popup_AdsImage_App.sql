CREATE PROCEDURE  [dbo].[Update_Popup_AdsImage_App] 
(
	@id int,
	@name varchar(150),
...
BEGIN 
	...
	iphone8_image=@iphone8_image,
	iphone8plus_image=@iphone8plus_image,
	iphone11_image=@iphone11_image,
	iphone14_image=@iphone14_image
	where id = @id
