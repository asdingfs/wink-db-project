CREATE PROCEDURE [dbo].[Get_Expired_eVouchersList_By_TokenId_And_Duration]
...
BEGIN
	...
	ELSE 
		...
		SELECT  * FROM customer_earned_evouchers where 
		customer_earned_evouchers.used_status=0
		AND 
		customer_earned_evouchers.customer_id =@customerId
