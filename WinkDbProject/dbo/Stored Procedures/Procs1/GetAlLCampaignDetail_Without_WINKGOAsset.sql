CREATE PROCEDURE [dbo].[GetAlLCampaignDetail_Without_WINKGOAsset]
...
SELECT campaign.campaign_id,campaign.merchant_id,campaign.campaign_name,
                            ...
                            FROM campaign ,merchant--, ASSET_WINKGO
                            ...
                            AND campaign.campaign_id NOT IN (select campaign_id from  ASSET_WINKGO)
