CREATE PROCEDURE  [dbo].[Create_Footer_AdsImage_App] 
(   @name varchar(150),
...
BEGIN 
	...
	Insert into footer_ads_app (iphone6plus_image,iphone6_image,iphone5_image,android_small_image,android_large_image,image_status,created_at,updated_at,from_date,to_date,[url],[name],redirect_status,
	redirect_to_winktag,redirect_to_winktreats, home_status,iphoneX_image)
	values (@iphone6plus_image,@iphone6_image,@iphone5_image,@android_small_image,@android_large_image,@image_status,@current_date,@current_date,@from_date,@to_date,@url,@name,@redirect_status,
	@redirect_to_winktag,@redirect_to_winktreats,@home_status,@iphoneX_image)
