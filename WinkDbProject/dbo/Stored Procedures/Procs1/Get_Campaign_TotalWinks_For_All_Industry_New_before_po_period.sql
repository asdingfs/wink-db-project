CREATE PROCEDURE [dbo].[Get_Campaign_TotalWinks_For_All_Industry_New_before_po_period] 
AS
BEGIN
...
SELECT industry_id, industry_name,SUM(all_time_total_winks) AS all_time_total_winks ,
SUM(ISNULL(redeemed_winks,0)) AS redeemed_winks from #CAMPAIGN_INSUSTRY_TABLE_1
GROUP By industry_id,industry_name
