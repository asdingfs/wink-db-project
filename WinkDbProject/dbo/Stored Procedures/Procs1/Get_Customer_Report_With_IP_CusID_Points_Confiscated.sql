...
CREATE PROCEDURE [dbo].[Get_Customer_Report_With_IP_CusID_Points_Confiscated]      
 (@start_date datetime,      
  @end_date datetime,      
 ...
 BEGIN    
  ...
  ;WITH customer_action_log_temp AS
		 ...
		 Insert Into #Customer_Report_Table (customer_id,first_name,last_name,email,status,     
		  ...
		  Total_Winks,total_winks_confiscated,total_points_confiscated, alltime_Total_Winks, Redeemed_Points,alltime_Redeemed_Points, Trip_Points, alltime_Total_Trip_Points,ip_address)      
