CREATE PROC [dbo].[Social_Media_Acq22_Simplified_Report]
(
	@wid varchar(50),
	@customerId int,
...
BEGIN
	...
	SELECT ROW_NUMBER() OVER (Order by w.created_at ASC)AS [no], cus.WID, w.customer_id, cus.email,
	cus.first_name +' '+cus.last_name AS customerName, cus.gender,
