CREATE PROCEDURE [dbo].[Get_Available_WINK_Gate_IDs_testing]
(
...
BEGIN
	...
	--campaign start date, booked started date, booked end date, campaign end date (done)
	--booked started date, campaign start date, campaign end date, booked end date, (done)
	--booked started date,  campaign start date, booked end date, campaign end date (done)
	--campaign start date, booked started date, campaign end date, booked end date (done)
	-- campaign start date,campaign end date, booked started date,booked end date
	--booked started date,booked end date, campaign start date,campaign end date
END
