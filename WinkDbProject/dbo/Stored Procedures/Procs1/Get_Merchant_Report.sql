CREATE PROCEDURE [dbo].[Get_Merchant_Report]    
...
BEGIN    
 ...
 (     
  ...
  (    
   ...
   /*CAST(@start_date as DATE) >= CAST(campaign.campaign_start_date as DATE) and     
   CAST(@start_date as DATE) <= CAST(campaign.campaign_end_date as DATE)  */---popo comment
 ...
 /*((CAST(@start_date as DATE) >= CAST(campaign.campaign_start_date as DATE) and     
  ...
  AND ((CAST(campaign.campaign_start_date as DATE) >= CAST(@start_date as DATE) and     
   CAST(campaign.campaign_start_date as DATE) <=CAST(@end_date as DATE) )   
   
   or  
   (CAST(campaign.campaign_end_date as DATE) >= CAST(@start_date as DATE) and     
   CAST(campaign.campaign_end_date as DATE) <=CAST(@end_date as DATE) ) ) 
