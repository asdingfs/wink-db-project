CREATE PROC [dbo].[ANALYTICS_INSERT_CURRENT_MONTH_ACTIVE_USER_FOR_TRIP]
...
declare @end_date_of_prev_month date = EOMONTH(DATEADD(MONTH,-1,cast(@date+'-01' as date)))
	...
	truncate table customer_active


	insert into customer_active (customer_id,period,create_at)
