CREATE  PROCEDURE [dbo].[Get_Top5_Advertisers_ByRedemptions]
AS
BEGIN
-- Check null or empty
...
(
	...
	SELECT TOP 5 #tmpmerchant.first_name AS merchant_name,#tmpmerchant.mas_code,SUM(ISNULL(#tmpmerchant.total_winks,0)) AS total_winks
	FROM #tmpmerchant
