...
Create PROC [dbo].[Get_Scan_Points_GPSLocation_Mediaparty2017_nangbak]          
...
--lucky draw
If CAST(@CURRENT_DATETIME as time) < '16:00:00' OR CAST(@CURRENT_DATETIME as time) > '21:30:00'
