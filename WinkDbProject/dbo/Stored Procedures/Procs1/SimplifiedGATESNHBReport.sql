...
CREATE PROCEDURE [dbo].[SimplifiedGATESNHBReport]
(
	@wid varchar(50),
	@customer_id int,
	@name varchar(100),
...
BEGIN
	...
	DECLARE @winkGateCampaignId int = 42
	...
	BEGIN
		...
		(
			...
			ON e.bookingId = b.id
			WHERE b.wink_gate_campaign_id = @winkGateCampaignId
			AND b.[status] = 1
