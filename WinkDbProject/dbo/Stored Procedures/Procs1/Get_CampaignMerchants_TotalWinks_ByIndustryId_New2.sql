CREATE PROCEDURE [dbo].[Get_CampaignMerchants_TotalWinks_ByIndustryId_New2]
(
@industryId int
)
AS
...
IF OBJECT_ID('tempdb..#CAMPAIGN_2') IS NOT NULL DROP TABLE #CAMPAIGN_2
	...
	IF (@industryId != 12) --Not Global
	 BEGIN
	/*------------Display By Campaign -------------------- 09/11/2016-----*/
