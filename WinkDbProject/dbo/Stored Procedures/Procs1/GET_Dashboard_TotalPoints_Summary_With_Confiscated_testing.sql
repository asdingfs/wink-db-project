...
CREATE PROCEDURE [dbo].[GET_Dashboard_TotalPoints_Summary_With_Confiscated_testing] 
AS
BEGIN
	...
	select SUM(customer_balance.total_points-(customer_balance.used_points + customer_balance.confiscated_points)) AS points_balance,
	SUM(customer_balance.total_points-(customer_balance.used_points + customer_balance.confiscated_points))/@points_per_wink as equivalent_wink,
