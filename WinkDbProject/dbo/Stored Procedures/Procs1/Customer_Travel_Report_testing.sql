...
CREATE PROCEDURE [dbo].[Customer_Travel_Report_testing]
	(@customer_id int,
	@WID varchar(20),
...
BEGIN
	...
	SELECT * FROM(
		...
		T.points_credit_status, T.point_redemption_date, T.points_expired_status, T.campaign_name
		FROM (
			...
			A.points_credit_status,A.point_redemption_date,A.points_expired_status,
			...
			0 as points_credit_status, NULL as point_redemption_date, '' as points_expired_status, '' as campaign_name
