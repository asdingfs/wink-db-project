CREATE PROCEDURE [dbo].[Get_Campaign_Report_With_NoDateFilter_NotUsed]
...
merchant.mas_code,merchant.first_name,merchant.last_name,campaign.agency,campaign.agency_comm,
campaign.sales_commission,campaign.created_at,
campaign.wink_purchase_only,campaign.wink_purchase_status,campaign.campaign_status,
...
campaign.sales_commission,campaign.merchant_id,campaign.campaign_status,
merchant.mas_code,merchant.first_name,merchant.last_name,campaign.agency,campaign.sales_commission,campaign.agency_comm,
campaign.campaign_start_date,campaign.campaign_end_date,campaign.created_at,campaign.wink_purchase_only,campaign.wink_purchase_status
