CREATE PROC [dbo].[Get_Scan_Points_GPSLocation_NDP52]          
...
--NDP52 Campaign
	...
	IF @qrcode = 'NDP52_NDP52_01_49652'
	BEGIN
		IF (SELECT COUNT(*) FROM customer_earned_points WHERE qr_code = 'NDP52_NDP52_01_49652') = 4000
		BEGIN
			SELECT '0' as response_code, 'Thank you for your support. Campaign has ended.' as response_message , 3 as timer_interval_second
			RETURN;
		END
	END
--NDP52 Campaign
