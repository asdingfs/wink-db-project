CREATE PROCEDURE [dbo].[Get_Ads_Trackers]
(
	@report varchar(250),
...
Exec GET_CURRENT_SINGAPORT_DATETIME @current_datetime output
	...
	BEGIN
		...
		c.WID as wid, c.customer_id as cid, c.first_name +' '+c.last_name as customer_name,c.email as customer_email, c.gender,(select floor(datediff(day,c.date_of_birth, DATEADD(HOUR,8,GETDATE())) / 365.25)) as age,
