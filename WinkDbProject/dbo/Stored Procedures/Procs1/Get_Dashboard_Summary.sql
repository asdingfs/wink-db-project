CREATE PROCEDURE [dbo].[Get_Dashboard_Summary]
...
BEGIN
	...
	@TOTAL_eVOUCHER AS TOTAL_eVOUCHER , @TOTAL_REDEEMED_EVOUCHER AS TOTAL_REDEEMED_eVOUCHER,@confiscated_winks as confiscated_winks,
