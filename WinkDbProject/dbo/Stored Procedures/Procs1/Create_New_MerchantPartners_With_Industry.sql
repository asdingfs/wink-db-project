...
CREATE Procedure [dbo].[Create_New_MerchantPartners_With_Industry]
(
...
SET @merchant_id =0
Insert into merchant_partners (name,created_at,updated_at,status,industry_id,logo,url,link_to_website_status) values 
