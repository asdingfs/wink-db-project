CREATE PROCEDURE [dbo].[SP_Get_WinkHunt_Access_Code]
    @campaignId int,
    @customerId int,
...
BEGIN
    ...
    BEGIN
        SELECT '0' AS success, 'Oops! You just missed out! Stay tuned for more promotions!' as msg;
        RETURN
    END
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT '1' AS success, 'Check your email for your WINK Hunt game card promo code!' AS msg, @promo_code AS accessCode, @cusEmail AS cusEmail, @cusName AS cusName;
        END
        ELSE
        BEGIN
