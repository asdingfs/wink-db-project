CREATE PROCEDURE [dbo].[Get_Customer_Report-bak15042016_working]    
 (@start_date datetime,    
  @end_date datetime,    
...
-- Without Date Time Filter    
 ...
 BEGIN    
  ...
  Total_Winks, alltime_Total_Winks, Redeemed_Points,alltime_Redeemed_Points, Trip_Points, alltime_Total_Trip_Points,ip_address )     
